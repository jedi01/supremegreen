...
<div class="row" style="justify-content: center;">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" method="POST" action="<?php echo base_url('authenticate'); ?>">
			<h2>  Supreme Green</h2>
			<hr class="colorgraph">
          ...
          <input type="hidden" name="role" value="<?php echo $role; ?>">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-12">
                    ...
                    <a href="<?php echo base_url('registration'); ?>">Create Account</a> <span>OR</span>
                    <a href="<?php echo base_url('guest'); ?>">Login As Guest</a>
                </div>
