            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="media d-flex">
                        ...
                        <div>
                            <i class="fa fa-archive info font-large-2 float-right"></i>
                        </div>
                    </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="media d-flex">
                        ...
                        <div>
                            <i class="fa fa-heart warning font-large-2 float-right"></i>
                        </div>
                    </div>
                    <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="media d-flex">
                        ...
                        <div>
                            <i class="fa fa-pie-chart success font-large-2 float-right"></i>
                        </div>
                    </div>
                    <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="media d-flex">
                        ...
                        <div>
                            <i class="fa fa-shopping-cart danger font-large-2 float-right"></i>
                        </div>
                    </div>
                    <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
